...
namespace D04_ConversaoDados
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(i1 + i2);     // 30   int + int --> somou
            #endregion
            ...
            // Parse é um método do tipo de dados numérico para converter em string
            Console.WriteLine(d1 + double.Parse(s1));       // 8,1
            Console.WriteLine(i1 + int.Parse(s1));
            Console.WriteLine(f1 + float.Parse(s1));
            Console.WriteLine(d1 + Convert.ToDouble(s1));   // 8,1
